...
//     addObserver:self selector:@selector(update1) name:@"update1" object:nil];
//    /*用来修改返回 HomeViewController tabBar*/
//    [[NSNotificationCenter defaultCenter]
//     addObserver:self selector:@selector(update2) name:@"update2" object:nil];
//    /*用来修改历史记录页面*/
//    [[NSNotificationCenter defaultCenter]
...
//}
///*返回HomeViewController时显示tabBar*/
//- (void)update2
//{
//    NSTimeInterval animationDuration = 0.3424f;
//    [UIView beginAnimations:@"ResignzeForKeyboard" context:nil];
//    [UIView setAnimationDuration:animationDuration];
